...
<body>
	<div class="header_margin container d-flex flex-wrap"
		...
		<ul class="nav me-auto">
			<li><a class="navbar-brand nav-link link-dark px-2"
				href="${pageContext.request.contextPath}/main/main">MOKKOJI</a></li>
		</ul>
		<ul class="nav">
			<c:if test="${sessionID == null}">
				...
				<li class="nav-item"><a class="nav-link link-dark px-2"
					href="${pageContext.request.contextPath}/member/join">Sign up</a></li>
			</c:if>
			<c:if test="${sessionID != null}">
				<li><a href="${pageContext.request.contextPath}/member/mypage"><span
						style="color: #269F70;">${sessionID}회원님</span></a></li>
